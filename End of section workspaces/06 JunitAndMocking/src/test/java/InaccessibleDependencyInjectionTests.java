...
import utilities.ExchangeRatesWithInaccessibleDependencies;

import static org.junit.jupiter.api.Assertions.*;
import static org.mockito.Mockito.*;

@ExtendWith(MockitoExtension.class)
public class InaccessibleDependencyInjectionTests {

    @Mock
    DatabaseUtils dbUtils;

    @InjectMocks
    ExchangeRatesWithInaccessibleDependencies exchangeRates;
