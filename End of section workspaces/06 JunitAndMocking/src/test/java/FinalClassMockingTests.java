...
import utilities.DatabaseUtilsFinal;
import utilities.ExchangeRatesWithFinalClass;
...
public class FinalClassMockingTests {

    @Mock
    DatabaseUtilsFinal dbUtils;

    @InjectMocks
    ExchangeRatesWithFinalClass exchangeRates;
