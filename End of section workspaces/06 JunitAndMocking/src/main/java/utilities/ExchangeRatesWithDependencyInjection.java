...
public class ExchangeRatesWithDependencyInjection {

    private DatabaseUtils dbUtils;
    private final Logger logger = Logger.getLogger("ExchangeRates");

    /* This example sets the dependency in the constructor but it would work equally
        well if it were set in a setter method
     */
    public ExchangeRatesWithDependencyInjection(DatabaseUtils dbUtils) {
